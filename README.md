...
<fieldset style="border: 2px solid #F82A94; border-radius: 10px; padding: 20px; max-width: 800px;">
  ...
  <em>
Sou um aspirante a DevOps e estudante do 1° semestre de <strong>Análise e Desenvolvimento de Sistemas</strong> na <strong>Estacio</strong>. O que me motiva vai além do código. É a possibilidade de usar o que sei para ajudar pessoas e empresas a crescerem, de fazer conexões entre tecnologia e resultado prático, e de colaborar com quem também está construindo algo com propósito.
Acredito que os melhores profissionais são aqueles que nunca param de aprender e eu levo isso a sério todos os dias.</p>
  </em> 
<p align="left">
  ...
  <br>
<div align= "left">
  <legend align="left"><h1>Tecnologias conhecidas:</h1></legend>
</div>
<br>
...
<br>  
    <kbd>
    <kbd>Computação em Nuvem & infra</kbd>
    <br>
    <br>
...
[**Complysoft**](https://complysolutions.com.br/) • Full-time \
Linguagens & Tecnologias: `C#`, `Python`, `Resolução de problemas`, `Atendimento ao Cliente`, `Automação Empresarial`\
<br/>

[<img align="left" height="94px" width="94px" alt="Rocketseat" src="https://i.ibb.co/7dgJbcg9/open-consult-logo.jpg"/>](https://www.openconsult.com.br/)

**Analista de sistema Pleno** \
[**Open Consult**](https://www.openconsult.com.br/) • Contract \
Linguagens & Tecnologias: `LDAP`, `SQL`, `XML`, `Análise de dados`, `SOAP`, `Análise de software`, `Micro-focus`\
<br/>

<img align="left" height="94px" width="94px" alt="Nubank" src="https://i.ibb.co/qFk0XSLg/target-logo-01.png"/>
...
<h1>Experiência Educacional</h1>

[<img align="left" height="94px" width="94px" alt="Nubank" src="https://i.ibb.co/93zSXmCt/estacio-logo-faculdade-2-0.jpg"/>](https://estacio.br/)
